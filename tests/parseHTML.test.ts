...
import compotechHtml from '../core/assets/compotech.html?raw'
import bcnextHtml from '../core/assets/bnext.html?raw'
import chinatestHtml from '../core/assets/chinatest.html?raw'
import cteeHtml from '../core/assets/ctee.html?raw'
import digitimes1Html from '../core/assets/digitimes1.html?raw'
import digitimes3Html from '../core/assets/digitimes3.html?raw'
import digitimes4Html from '../core/assets/digitimes4.html?raw'
import investorHtml from '../core/assets/investor.html?raw'
import nextappleHtml from '../core/assets/nextapple.html?raw'
import saydigitHtml from '../core/assets/saydigit.html?raw'
import setnHtml from '../core/assets/setn.html?raw'
import techrangeHtml from '../core/assets/techrange.html?raw'
import wealthHtml from '../core/assets/wealth.html?raw'
import { NewsArticleTestSchema } from 'NewsArticleTestSchema'
describe('Test scraping from HTML', () => {
    ...
    test('scrape ctee', async () => {
        const result = await dmsScrape(
            'https://www.ctee.com.tw/news/20241011700170-439901',
            cteeHtml
        )
        expect(result).toMatchObject(NewsArticleTestSchema)
    })
