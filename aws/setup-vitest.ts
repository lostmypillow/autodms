...
// Set environment variables BEFORE any test files or application code import them
...
export const testDocClient = DynamoDBDocumentClient.from(rawClient)

beforeAll(async () => {
    const TABLE_NAME = process.env['TABLE_NAME']!

    // Reset Table Schema once before all files run
    try {
    ...
    try {
        ...
        await rawClient.send(
            new PutCommand({
                ...
                Item: {
                    PK: 'DATE#2026-09-30',
                    SK: 'URL#c4c531283353bc2be26166eff42bdd280ec72b51485b43b7c57bb8a7e82c4636',
